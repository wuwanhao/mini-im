...
CREATE TABLE `friend_requests` (
   ...
   PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='好友请求列表';
...
CREATE TABLE `group_members` (
 ...
 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='群-群成员关系映射表';
...
CREATE TABLE `group_requests` (
  ...
  `handle_result`  tinyint COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理结果',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='入群请求列表';
