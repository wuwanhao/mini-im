...
const (
	...
	Social_GroupMemberList_FullMethodName   = "/social.social/GroupMemberList"
)
...
func (c *socialClient) GroupMemberList(ctx context.Context, in *GroupMemberListReq, opts ...grpc.CallOption) (*GroupMemberListResp, error) {
	out := new(GroupMemberListResp)
	err := c.cc.Invoke(ctx, Social_GroupMemberList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSocialServer) GroupMemberList(context.Context, *GroupMemberListReq) (*GroupMemberListResp, error) {
...
func _Social_GroupMemberList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GroupMemberListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SocialServer).GroupMemberList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Social_GroupMemberList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServer).GroupMemberList(ctx, req.(*GroupMemberListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Social_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Social_GroupMemberList_Handler,
		},
	},
